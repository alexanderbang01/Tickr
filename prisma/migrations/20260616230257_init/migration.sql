...
-- CreateEnum
CREATE TYPE "AssetType" AS ENUM ('FOREX', 'CRYPTO', 'INDICES');

-- CreateEnum
CREATE TYPE "Timeframe" AS ENUM ('M1', 'M5', 'M15', 'M30', 'H1', 'H4', 'D1', 'W1', 'MN');

-- CreateEnum
CREATE TYPE "PostStatus" AS ENUM ('ACTIVE', 'CLOSED', 'CANCELLED');
...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_marketPairId_fkey" FOREIGN KEY ("marketPairId") REFERENCES "MarketPair"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
